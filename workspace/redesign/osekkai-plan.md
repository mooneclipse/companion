# osekkai-plan — 夜時間おせっかいシステム 実装計画 (v0.2、**2026-07-15 OWNER 承認済**)

- **作成日**: 2026-07-14 (チケット #108)
- **承認**: 2026-07-15 OWNER 承認 (§6 承認ゲート 4 点込み)。Phase 1 実装はチケット #110、実装台帳は `~/companion/osekkai/docs/STATUS.md`
...
**2026-07-17 OWNER 裁定 (同日)**: 上記 watch も含め **Phase 2 は取りやめ、チケット #112 クローズ**。理由 = pixel-6 はバッテリー劣化が進んでおり常駐収集アプリを載せたくない + PC の記録で夜の行動把握は足りる。将来 Android 収集を再検討する場合は本節の再調査結果から読み直して新チケットを切る。
