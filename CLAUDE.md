...
**最終更新**: 2026-07-11 (git 運用方針をモノレポ前提に全面改稿 — 3 階層 (A)(B)(C) 廃止、境界外 3 つ (vault/photos/logs)、push は OWNER 1 コマンド。チケット #82、手順書 `workspace/redesign/monorepo-migration.md` Phase 4。前回 2026-07-08: (C) 列挙追記)
