...
最終更新: 2026-05-28 (RV-5 build 検証 🔴必須項目 完了: V-A1 ✅ / V-A3 hwdec ✅(fps 27→60, CPU 1/3) / V-A6 ✅(RAM 160-244 MB)、video-zoom=-0.05 ✅。5 秒周期 Live edge 追従 stall は別軸 = RV-8 として TODO 化)
