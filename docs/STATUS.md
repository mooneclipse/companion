...
最終更新: 2026-05-22 (F-video 追加要望 RV-6/RV-7 実装完了 / 実機確認はユーザー在席時)
...
- 2026-05-22 **F-video 追加要望 RV-6（URL クリアボタン）+ RV-7（±N スキップ/ステップ可変）実装完了**
  ...
  - **実機確認は朝の dashboard 稼働(5:30〜9:00)を避け、ユーザー在席時にまとめて握る**（クリアボタン操作 / VOD で ±N スキップ・ステップ可変 / live で skiprow 非表示の目視）。
