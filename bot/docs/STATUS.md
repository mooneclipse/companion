...
- **デプロイ**: **restart 未実施** (本番 bot restart は OWNER 名指し承認が必要)。restart 後に post_init で BotCommand メニュー 2 件 (`rest` / `backlog`) も反映される
