...
- [ ] 共用 TODO **#100** の残観察: 2026-07-14 05:04 の定常実行サマリーで pending_retried=19 / pending 残 0 を確認したら done (実装は 2026-07-14 完了、Done エントリ参照)
